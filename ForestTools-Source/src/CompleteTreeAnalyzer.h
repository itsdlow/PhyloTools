...
#ifndef _CompleteTreeAnalyzer
#define _CompleteTreeAnalyzer
...
namespace phylo
{
	...
	class CompleteTreeAnalyzer: public TreeAnalyzer
	{
	public:
		CompleteTreeAnalyzer() = delete;
		CompleteTreeAnalyzer(distanceMeasure::DistanceMeasureCalculator* const* pCalculators, const int calculator_count);

		virtual ~CompleteTreeAnalyzer() = default;
		CompleteTreeAnalyzer(const CompleteTreeAnalyzer& bca) = delete;
		CompleteTreeAnalyzer& operator=(const CompleteTreeAnalyzer& bca) = delete;
